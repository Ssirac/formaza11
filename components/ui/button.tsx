...
const variants: Record<Variant, string> = {
  gold: "bg-metal-gold text-ink shadow-[0_6px_24px_-8px_rgba(227,178,60,0.6)] hover:shadow-[0_10px_34px_-6px_rgba(227,178,60,0.75)] hover:brightness-105 active:scale-[0.98]",
  silver:
